...
from winter.argument_resolver import resolve_arguments, register_argument_resolver
...
def test_resolve_arguments_returns_empty_dict_for_empty_arguments(clear_resolvers):
    def func():
        pass
    ...
    # Act
    resolved_arguments = resolve_arguments(controller_method, http_request=Mock(), path_variables={})

    # Assert
    assert resolved_arguments == expected_resolved_arguments


def test_resolve_arguments_resolves_argument_with_the_first_resolver(clear_resolvers):
    def func(a: int):
        pass
    ...
    register_argument_resolver(resolver)
...
def test_resolve_arguments_resolves_argument_with_the_second_resolver(clear_resolvers):
    def func(a: int):
        pass
...
def test_resolve_arguments_resolves_argument_with_the_path_variable(clear_resolvers):
    def func(a: int):
        pass
    ...
    # Act
    resolved_arguments = resolve_arguments(controller_method, http_request=Mock(), path_variables=path_variables)

    # Assert
    assert resolved_arguments == expected_resolved_arguments


def test_resolve_arguments_fails(clear_resolvers):
    def func(a: int):
        pass
    ...
    # Assert
    with pytest.raises(Exception, match=f'Unable to resolve argument {arg_name}: int'):
        # Act
        resolve_arguments(controller_method, http_request=Mock(), path_variables={})
